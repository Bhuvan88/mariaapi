...
`),s("span",{class:"hljs-punctuation"},"}"),e(`
`)])],-1),ge=s("hr",null,null,-1),fe=s("h2",{id:"login-using-sso-providers",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#login-using-sso-providers"},"#"),e(" Login Using SSO Providers")],-1),be=s("p",null,"Will redirect to the configured SSO provider for the user to login.",-1),je=s("pre",null,[s("code",null,`GET /auth/login/:provider
`)],-1),me=s("hr",null,null,-1),ve="Authentication",xe=!1,Te="API documentation on authentication in Directus.",Pe="5 min read",Se="page-reference",Re={name:"authentication",setup(ke,{expose:r}){const a={title:"Authentication",modularExtension:!1,description:"API documentation on authentication in Directus.",readTime:"5 min read",pageClass:"page-reference"};return r({frontmatter:a}),(we,ye)=>{const n=l("router-link"),i=l("docs-wrapper");return h(),c(i,{frontmatter:a},{default:t(()=>[s("div",u,[s("blockquote",null,[s("p",null,[d,o(n,{to:"/docs/configuration/users-roles-permissions#configure-permissions"},{default:t(()=>[p]),_:1}),_])]),g,f,b,j,m,k,w,y,q,v,x,T,P,S,R,A,O,E,L,I,B,N,s("div",G,[C,s("p",null,[D,o(n,{to:"/docs/self-hosted/config-options#general"},{default:t(()=>[J,W,Q]),_:1}),z])]),H,V,U,K,F,M,Y,X,Z,$,ss,es,ts,ns,os,as,ls,rs,is,hs,cs,us,ds,ps,_s,gs,fs,bs,js,ms,ks,ws,ys,qs,vs,xs,Ts,Ps,Ss,s("p",null,[Rs,As,Os,Es,Ls,Is,o(n,{to:"/docs/self-hosted/config-options#security"},{default:t(()=>[Bs,Ns]),_:1}),Gs]),Cs,Ds,Js,Ws,Qs,zs,Hs,Vs,Us,Ks,Fs,Ms,Ys,Xs,Zs,$s,se,ee,te,ne,oe,s("div",ae,[le,s("p",null,[re,o(n,{to:"/docs/self-hosted/config-options#authentication"},{default:t(()=>[ie]),_:1}),he])]),ce,ue,de,pe,_e,ge,fe,be,je,me])]),_:1})}}};export{Re as default,Te as description,xe as modularExtension,Se as pageClass,Pe as readTime,ve as title};
